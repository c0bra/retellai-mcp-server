...
export const registerRetellLLMTools = (server: McpServer, retellClient: Retell) => {
	server.registerTool(
		"list_retell_llms",
	...
	server.registerTool(
		...
		createToolHandler(async (data: z.infer<typeof CreateRetellLLMInputSchema>) => {
	...
	server.registerTool(
		...
		createToolHandler(async (data: z.infer<typeof GetRetellLLMInputSchema>) => {
			try {
	...
	server.registerTool(
		...
		createToolHandler(async (data: z.infer<typeof UpdateRetellLLMInputSchema>) => {
			try {
